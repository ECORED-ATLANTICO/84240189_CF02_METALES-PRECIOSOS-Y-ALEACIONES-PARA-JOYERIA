...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center
      .col-xl-9.mb-3.order-2.order-xl-1
      ...
      .col-xl-8
        ul.lista-ul--color
          li.d-flex 
            ...
            p.text-bold.mb-0 El reactivo utilizado para la piedra de toque es comúnmente denominado “agua de la piedra de toque” y tiene su origen en el agua regia, que está formada por:
        .tabla-a.color-acento-botones.mb-3.text-center
          table
            thead
              tr.bgr_4
                th Ácido clorhídrico
                th 3 o 4 partes
            tbody.bgr_5
              tr
                td Ácido nítrico
        ...
        ul.lista-ul--color
          li.d-flex 
            i.fas.fa-check-circle.bgr
            p.text-bold.mb-0 Para oro de 900 milésimas: 
        .tabla-a.color-acento-botones.mb-3.text-center
          table
            thead
              tr.bgr_4
        ...
        ul.lista-ul--color
          li.d-flex 
            i.fas.fa-check-circle.bgr
            p.text-bold.mb-0 Para oro de 750 milésimas: 
        .tabla-a.color-acento-botones.mb-3.text-center
          table
            thead
              tr.bgr_4
        ...
        ul.lista-ul--color
          li.d-flex 
            i.fas.fa-check-circle.bgr
            p.text-bold.mb-0 Para oro de 583 milésimas:  
        .tabla-a.color-acento-botones.mb-3.text-center
          table
            thead
              tr.bgr_4
    ...
    .row.mb-5.justify-content-center
      ...
      .col-xl-7.order-1.order-xl-2.mb-3
        p Todas las fórmulas indicadas anteriormente son a título orientativo, es adecuado experimentar con las propias aleaciones y reforzarlas o debilitarlas según el caso. 
        p Para oro bajo de 15 a 500 milésimas, se utiliza ácido nítrico de 32 grados Beaume, diluido en agua destilada.
        p Las reacciones para pruebas de piezas en plata:
      ...
      .col-lg-7.col-xl-8.mb-3
        ol.lista-ol--cuadro.lista-ol--separador
          ...
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 3
            | Ataca el cobre con color verde o azul. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 4
            | Ataca el paladio, encuartado, en color rojo. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 5
            | Mezclado con agua ataca violentamente al zinc. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 6
            | No ataca al oro ni al platino. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 7
          ...
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 8
            | Cobre y níquel dan color azulado Hierro da color pardo. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 9
            | Cobalto da color rosa. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 10
            | Plomo estaño, zinc y cadmio incoloros. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 11
            | Palta da color marfil precipitando cloruro de plata. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 12
            | Oro da color rojo amarillento. 
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 13
            | Platino en caliente da color amarillo oscuro.
          li.d-flex
            .lista-ol--cuadro__vineta.bgr_6.d-
              span 14
    ...
    .row.mb-3(data-aos="fade-right")
      .col-auto
        figure
          img(src="@/assets/template/fri.svg", alt="alt")
      .col.p-0
        h4 Ensayo de oro, de sus aleaciones, sin copelación (sistema casero)
    ...
    .row.mb-5.justify-content-center
      ...
      .col-xl-8
        ul.lista-ul--color
          ...
          li.mb-0.d-flex 
            i.lista-ul__vineta
            | Se añade a la plata fundida, el oro de la muestra, procurando que no se pierda ni la más mínima partícula.  
          li.mb-0.d-flex 
            i.lista-ul__vineta
          ...
          li.mb-0.d-flex 
            i.lista-ul__vineta
            | Ahora se lava, por decantación, con agua destilada, unas seis veces y se pasa el metal a un crisol de porcelana, con la ayuda de un frasco lavador.  
          li.mb-0.d-flex 
            i.lista-ul__vineta
        ...
        LineaTiempoD.color-primario.mb-5
          ...
          div(numero="4" titulo="Fórmula para la densidad")
            ...
            .row.justify-content-center
              .col-auto
                div.tarjeta.bgr_10.p-4.text-white.justify-content-center
                  p.mb-0 14K-12,9 a 14,6 gr/ml
                  p.mb-0 18K amarillo-15,2 a 15,9 gr/ml
                  p.mb-0 18K blanco-14,7 a 16,9 gr/ml
                  p.mb-0 2K-17,7 a 17,8 gr/ml

          div(numero="5" titulo="Advertencia en la prueba de densidad")
    ...
    .row.mb-3(data-aos="fade-right")
      .col-auto
        figure
          img(src="@/assets/template/fri.svg", alt="alt")
      .col.p-0
        h4 Modificar la ley de los metales
